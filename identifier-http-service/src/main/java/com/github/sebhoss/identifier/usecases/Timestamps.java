...
class Timestamps {
    ...
    @Autowired
    Timestamps(final Identifiers identifiers) {
        this.identifiers = identifiers;
    }

    @ResponseBody
    public String timestamp() {
        return identifiers.nextTimestamp();
    }

    @ResponseBody
    @RequestMapping("/base36")
    public String timestampInBase36() {
        return identifiers.nextTimestampInBase36();
    }

    @ResponseBody
    @RequestMapping("/base64")
    public String timestampInBase64() {
        return identifiers.nextTimestampInBase64();
    }
